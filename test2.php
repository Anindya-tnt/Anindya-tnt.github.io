...
<body>
	<div class="container">
	<div class="jumbotron">
	<div class="row"><h2>Introduction to Unsupervised Learning</h2><div class="col-xs-4">
			
	<div class="video-container">
		<video id="video" class="video-js" width="500" height="360" controls>
		...
		<div class="col-xs-6"><div id="transcript" style="margin-top: 80px; width:500px; border:4px solid black"></div>
		<script>
	...
	<div class="col-xs-12">
			<h2>Snapshot</h2>
			<canvas id="canvas1" allign="right"></canvas>
